...
export class BandagingDashboardComponent implements OnInit, AfterViewInit, OnDestroy {
...
// weights = Weights;
  ...
  callback(data){
    ...
    if(this.mainPlan.score == -1) {
      localStorage.setItem('Bandage', 'no data');
      this.pageError = true;
    } else {
